...
use crate::{jade::ecs::components::transform::Transform, renderer::{Renderable, ZIndex, mesh::Mesh, primitive::draw_command::{Color, DrawCommand}}, util::assets::assetpool::TextureAsset};
...
impl RenderInfo
{
    ...
    {
        self.draw_commands.push(
            DrawCommand::FilledRect { pos, size, color }
        )
    }
}
